...
export function ReservationEmptyState({
  ...
  return (
    <div className="flex flex-col items-center rounded-[32px] border border-dashed border-slate-300 bg-white p-10 text-center shadow-[0_16px_40px_rgba(15,23,42,0.05)]">
